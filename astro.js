function zodiac() {
    ...
    if (birthmonth == 1 && birthday >= 20 || birthmonth == 2 && birthday <= 18) {
        result = ("Aquarius");
        document.getElementById("zodiac").style.backgroundImage = "url('./img/Aqua.PNG')"; 
        document.getElementById("zodiac").style.backgroundPosition = "center"; 
        document.getElementById("zodiac").style.backgroundSize = "100%"; 
        document.getElementById("zodiac").style.backgroundRepeat = "no-repeat";
    ...
    if (birthmonth == 2 && birthday >= 19 || birthmonth == 3 && birthday <= 20) {
        result = ("Pisces");
        document.getElementById("zodiac").style.backgroundImage = "url('./img/Pisc.PNG')"; 
        document.getElementById("zodiac").style.backgroundPosition = "center"; 
        document.getElementById("zodiac").style.backgroundSize = "100%"; 
        document.getElementById("zodiac").style.backgroundRepeat = "no-repeat";
    ...
    if (birthmonth == 3 && birthday >= 21 || birthmonth == 4 && birthday <= 19) {
        result = ("Aries");
        document.getElementById("zodiac").style.backgroundImage = "url('./img/Ari.PNG')"; 
        document.getElementById("zodiac").style.backgroundPosition = "center"; 
        document.getElementById("zodiac").style.backgroundSize = "100%"; 
        document.getElementById("zodiac").style.backgroundRepeat = "no-repeat";
        ...
        document.getElementById("celebrities").innerHTML = "Elton John, Steven Tyler, Lady Gaga";
    }

    if (birthmonth == 4 && birthday >= 20 || birthmonth == 5 && birthday <= 20) {
        result = ("Taurus");
        document.getElementById("zodiac").style.backgroundImage = "url('./img/Taur.PNG')"; 
        document.getElementById("zodiac").style.backgroundPosition = "center"; 
        document.getElementById("zodiac").style.backgroundSize = "85%"; 
        document.getElementById("zodiac").style.backgroundRepeat = "no-repeat";
    ...
    if (birthmonth == 5 && birthday >= 21 || birthmonth == 6 && birthday <= 20) {
        result = ("Gemini");
        document.getElementById("zodiac").style.backgroundImage = "url('./img/Gem.PNG')"; 
        document.getElementById("zodiac").style.backgroundPosition = "center"; 
        document.getElementById("zodiac").style.backgroundSize = "80%"; 
        document.getElementById("zodiac").style.backgroundRepeat = "no-repeat";
    ...
    if (birthmonth == 6 && birthday >= 21 || birthmonth == 7 && birthday <= 22) {
        result = ("Cancer");
        document.getElementById("zodiac").style.backgroundImage = "url('./img/Canc_.PNG')"; 
        document.getElementById("zodiac").style.backgroundPosition = "center"; 
        document.getElementById("zodiac").style.backgroundSize = "cover"; 
        document.getElementById("zodiac").style.backgroundRepeat = "no-repeat";
    ...
    if (birthmonth == 7 && birthday >= 23 || birthmonth == 8 && birthday <= 22) {
        result = ("Leo");
        document.getElementById("zodiac").style.backgroundImage = "url('./img/leo_.PNG')"; 
        document.getElementById("zodiac").style.backgroundPosition = "center"; 
        document.getElementById("zodiac").style.backgroundSize = "500px";
        document.getElementById("zodiac").style.backgroundRepeat = "no-repeat"; 
    ...
    if (birthmonth == 8 && birthday >= 23 || birthmonth == 9 && birthday <= 22) {
        result = ("Virgo");
        document.getElementById("zodiac").style.backgroundImage = "url('./img/Virg.PNG')"; 
        document.getElementById("zodiac").style.backgroundPosition = "center"; 
        document.getElementById("zodiac").style.backgroundSize = "80%"; 
        document.getElementById("zodiac").style.backgroundRepeat = "no-repeat";
    ...
    if (birthmonth == 9 && birthday >= 23 || birthmonth == 10 && birthday <= 22) {
        result = ("Libra");
        document.getElementById("zodiac").style.backgroundImage = "url('./img/Lib.PNG')"; 
        document.getElementById("zodiac").style.backgroundPosition = "center"; 
        document.getElementById("zodiac").style.backgroundSize = "cover"; 
        document.getElementById("zodiac").style.backgroundRepeat = "no-repeat";
    ...
    if (birthmonth == 10 && birthday >= 23 || birthmonth == 11 && birthday <= 21) {
        result = ("Scorpio");
        document.getElementById("zodiac").style.backgroundImage = "url('./img/scorp_.PNG')"; 
        document.getElementById("zodiac").style.backgroundPosition = "center"; 
        document.getElementById("zodiac").style.backgroundSize = "70%"; 
        document.getElementById("zodiac").style.backgroundRepeat = "no-repeat"; 
    ...
    if (birthmonth == 11 && birthday >= 22 || birthmonth == 12 && birthday <= 21) {
        result = ("Sagittarius");
        document.getElementById("zodiac").style.backgroundImage = "url('./img/Sag_.PNG')"; 
        document.getElementById("zodiac").style.backgroundPosition = "center"; 
        document.getElementById("zodiac").style.backgroundSize = "80%"; 
        document.getElementById("zodiac").style.backgroundRepeat = "no-repeat";
    ...
    if (birthmonth == 12 && birthday >= 22 || birthmonth == 1 && birthday <= 19) {
        result = ("Capricorn");
        document.getElementById("zodiac").style.backgroundImage = "url('./img/Cap.PNG')"; 
        document.getElementById("zodiac").style.backgroundPosition = "center"; 
        document.getElementById("zodiac").style.backgroundSize = "75%"; 
        document.getElementById("zodiac").style.backgroundRepeat = "no-repeat";
