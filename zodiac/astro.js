function zodiac() {
    ...
    if (birthmonth == 1 && birthday >= 20 || birthmonth == 2 && birthday <= 18) {
      result = ("Aquarius");
      document.getElementById("photo").innerHTML = "<img src='./img/verseau.png'width=20%>";
    ...
    if (birthmonth == 2 && birthday >= 19 || birthmonth == 3 && birthday <= 20) {
      result = ("Pisces");
      document.getElementById("photo").innerHTML = "<img src='./img/poisson.png'width=20%>";
    ...
    if (birthmonth == 3 && birthday >= 21 || birthmonth == 4 && birthday <= 19) {
      result = ("Aries");
      document.getElementById("photo").innerHTML = "<img src='./img/belier.png'width=20%>";
    ...
    if (birthmonth == 4 && birthday >= 20 || birthmonth == 5 && birthday <= 20) {
      result = ("Taurus");
      document.getElementById("photo").innerHTML = "<img src='./img/taureau.png'width=20%>";
    ...
    if (birthmonth == 5 && birthday >= 21 || birthmonth == 6 && birthday <= 20) {
      result = ("Gemini");
      document.getElementById("photo").innerHTML = "<img src='./img/gemeau.png'width=20%>";
    ...
    if (birthmonth == 6 && birthday >= 21 || birthmonth == 7 && birthday <= 22) {
      result = ("Cancer");
      document.getElementById("photo").innerHTML = "<img src='./img/cancer.png'width=20%>";
    ...
    if (birthmonth == 7 && birthday >= 23 || birthmonth == 8 && birthday <= 22) {
      result = ("Leo");
      document.getElementById("photo").innerHTML = "<img src='./img/lion.png'width=20%>";
    ...
    if (birthmonth == 8 && birthday >= 23 || birthmonth == 9 && birthday <= 22) {
      result = ("Virgo");
      document.getElementById("photo").innerHTML = "<img src='./img/vierge.png'width=20%>";
    ...
    if (birthmonth == 9 && birthday >= 23 || birthmonth == 10 && birthday <= 22) {
      result = ("Libra");
      document.getElementById("photo").innerHTML = "<img src='./img/balance.png'width=20%>";
    ...
    if (birthmonth == 10 && birthday >= 23 || birthmonth == 11 && birthday <= 21) {
      result = ("Scorpio");
      document.getElementById("photo").innerHTML = "<img src='./img/scorpion.png'width=20%>";
    ...
    if (birthmonth == 11 && birthday >= 22 || birthmonth == 12 && birthday <= 21) {
      result = ("Sagittarius");
      document.getElementById("photo").innerHTML = "<img src='./img/saggitaire.png'width=20%>";
    ...
    if (birthmonth == 12 && birthday >= 22 || birthmonth == 1 && birthday <= 19) {
      ...
      result = ("Capricorn");
      document.getElementById("photo").innerHTML = "<img src='./img/capricorne.png'width=20%>";
